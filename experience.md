...
**Trussed.AI | March 2025 – Present**

- Architecting LLM-powered agentic systems for insurance claims automation (LangChain, LangGraph)
- Built TrussController: compliance middleware with PII redaction, RBAC routing, and LLM provider abstraction
- Stateful multi-agent workflows via ClaimState (Pydantic) across the full claims lifecycle
- LLM performance evaluations, prompt engineering, and chain-of-thought optimization

<div class="old-experience-section" style="display:none;">
...
**SIMS Software | Oct 2018 – Feb 2025**

- Transformed monolithic defense platform into $10M+ multi-tenant cloud-native SaaS
- Served Pentagon, White House, FBI — 99.99% uptime for national security compliance
- Deployed AI-driven automation reducing process inefficiencies by 40%
- Scaled engineering team to 50+, mentored 10+ engineers into leadership
...
**The WiTT Group | Jun 2023 – Oct 2024**

- Led technology strategy for healthcare/fintech platform used by Miami Cancer Institute
- Built HIPAA-compliant AI systems for patient engagement
- Multi-tenant cloud architecture with Stripe PCI compliance
...
**SIMS Software | Oct 2012 – Sep 2018**

- Led cloud migration of legacy defense systems to modern architecture
- Introduced DevOps, CI/CD, and infrastructure as code
- Built predictive analytics applications for national security
